 ...
 * 容器高度 = 类似
 */
public class MyVerticalFlowLayout implements LayoutManager, Serializable {
    ...
    public MyVerticalFlowLayout(int hAlign, int vAlign, int hPadding, int vPadding, int hGap, int vGap, boolean fill, boolean wrap) {
        this.hAlign = hAlign;
        this.vAlign = vAlign;
    ...
    public MyVerticalFlowLayout() {
        this(LEFT, TOP, 5, 5, 5, 5, true, false);
    }

    public MyVerticalFlowLayout(int padding, int gap) {
        this(LEFT, TOP, padding, padding, gap, gap, true, false);
    }

    public MyVerticalFlowLayout(int padding) {
...
//		FlatDarkLaf.setup();
        ...
        MyVerticalFlowLayout layout = new MyVerticalFlowLayout();
        ...
        control.setLayout(new MyVerticalFlowLayout());
        ...
        hLeft.addActionListener(e -> {
            layout.setHAlign(MyVerticalFlowLayout.LEFT);
            panel.revalidate();
        ...
        hCenter.addActionListener(e -> {
            layout.setHAlign(MyVerticalFlowLayout.CENTER);
            panel.revalidate();
            System.out.println(layout);
        });
        hAlign.add(hCenter);
        ...
        hRight.addActionListener(e -> {
            layout.setHAlign(MyVerticalFlowLayout.RIGHT);
            panel.revalidate();
            System.out.println(layout);
        });
        hAlign.add(hRight);
        ...
        vTop.addActionListener(e -> {
            layout.setVAlign(MyVerticalFlowLayout.TOP);
            panel.revalidate();
            System.out.println(layout);
        });
        vAlign.add(vTop);
        ...
        vCenter.addActionListener(e -> {
            layout.setVAlign(MyVerticalFlowLayout.CENTER);
            panel.revalidate();
            System.out.println(layout);
        });
        vAlign.add(vCenter);
        ...
        vBottom.addActionListener(e -> {
            layout.setVAlign(MyVerticalFlowLayout.BOTTOM);
            panel.revalidate();
            System.out.println(layout);
        });
        vAlign.add(vBottom);
